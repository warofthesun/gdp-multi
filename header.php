...
<!--[if gt IE 8]><!--> <html <?php language_attributes(); ?> class="no-js"><!--<![endif]-->
	...
	<body <?php body_class(); ?> itemscope itemtype="http://schema.org/WebPage">
		...
		<div id="container">
			...
			<div style="background-image:url('<?php echo $image[0]; ?>');background-size:cover;background-position-y:80%;">
		...
		<div class="overlay">
			...
			<a href="/" rel="nofollow" class="logo col-xs-12 col-sm-4">
				<div>
					<img src="<?php echo get_template_directory_uri(); ?>/library/images/gdp-logo-white-alt.png">
				</div>
			</a>
